...
const SIMPLE_RENDER_URI="ui://simple/render/v7.html";
...
function render(payload){if(!payload)return;const p=payload.presentation||"GENERIC_LIST",data=payload.data||{};app.innerHTML=p==="WORK_GALLERY"?workGallery(data):p==="CLIENT_GRID"?clientGrid(data):p==="CREDENTIAL_LIST"?credentialList(data):p==="MANIFESTO"?manifestoView(data):rowsView(data)}
