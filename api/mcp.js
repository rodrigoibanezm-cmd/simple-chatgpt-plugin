...
module.exports=async(req,res)=>{
  ...
  registerAppTool(server,"render",{
    ...
    description:"Presentation step after execute. PORTFOLIO, CLIENT_LIST and CREDENTIALS collections have defined natural presentations and must be rendered. Copy execute.result.records unchanged; do not select, rename, omit, reshape, infer or recalculate record fields.",
    inputSchema:{
