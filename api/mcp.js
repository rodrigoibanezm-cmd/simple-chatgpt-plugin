...
const PRESENTATIONS=["WORK_GALLERY","CLIENT_GRID","CREDENTIAL_LIST","PROFILE","BRAND_IMMERSION","MANIFESTO","GENERIC_LIST"];
const SIMPLE_RENDER_URI="ui://simple/render/v9-experience.html";
...
.manifesto{background:#0b0b0b;color:#fff;border-radius:26px;padding:28px;min-height:360px;display:flex;flex-direction:column;justify-content:space-between;overflow:hidden}.manifesto-top{display:flex;justify-content:space-between;align-items:flex-start;gap:20px}.manifesto-logo{width:112px;max-height:48px;object-fit:contain;filter:invert(1)}.manifesto-kicker{font-size:11px;letter-spacing:.14em;text-transform:uppercase;opacity:.7}.manifesto-line{font-family:Georgia,serif;font-size:clamp(34px,7vw,68px);line-height:.93;letter-spacing:-.035em;max-width:760px;margin:42px 0 34px}.manifesto-copy{max-width:720px;font-size:16px;line-height:1.5;opacity:.86}.manifesto-copy strong{color:#fff}.manifesto-sign{width:min(420px,72%);margin-top:28px;filter:brightness(0) invert(1)}

.profile-experience{margin:-22px;min-height:620px;background:#0b0b0b;color:#f4f0e7;overflow:hidden;position:relative}.profile-hero{min-height:360px;padding:30px;display:flex;flex-direction:column;justify-content:space-between;border-bottom:1px solid rgba(255,255,255,.18);position:relative}.profile-hero:after{content:"SIMPLE";position:absolute;right:-18px;bottom:-34px;font-family:Georgia,serif;font-size:clamp(110px,24vw,240px);letter-spacing:-.09em;opacity:.06;pointer-events:none}.profile-kicker{font-size:11px;letter-spacing:.18em;text-transform:uppercase;opacity:.62}.profile-headline{font-family:Georgia,serif;font-size:clamp(48px,10vw,104px);line-height:.82;letter-spacing:-.065em;max-width:850px;margin:36px 0 20px}.profile-definition{max-width:720px;font-size:clamp(16px,2.4vw,23px);line-height:1.35;opacity:.82}.profile-numbers{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));border-bottom:1px solid rgba(255,255,255,.18)}.profile-number{padding:26px 30px;border-right:1px solid rgba(255,255,255,.18)}.profile-number:last-child{border-right:0}.profile-big{font-family:Georgia,serif;font-size:clamp(54px,10vw,110px);line-height:.8;letter-spacing:-.06em}.profile-label{margin-top:12px;font-size:11px;letter-spacing:.15em;text-transform:uppercase;opacity:.55}.profile-block{padding:28px 30px;border-bottom:1px solid rgba(255,255,255,.18)}.profile-block h2{font-family:Georgia,serif;font-size:clamp(38px,7vw,76px);line-height:.9;letter-spacing:-.045em;margin:8px 0 24px}.profile-capabilities{display:flex;flex-wrap:wrap;gap:8px}.profile-pill{border:1px solid rgba(255,255,255,.35);border-radius:999px;padding:10px 14px;font-size:13px}.profile-team{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1px;background:rgba(255,255,255,.16)}.profile-person{background:#0b0b0b;padding:20px;min-height:130px;display:flex;flex-direction:column;justify-content:flex-end}.profile-person strong{font-family:Georgia,serif;font-size:24px;line-height:1}.profile-person span{font-size:11px;letter-spacing:.08em;text-transform:uppercase;opacity:.55;margin-top:8px}.profile-position{font-family:Georgia,serif;font-size:clamp(28px,5vw,52px);line-height:1.02;max-width:850px}.profile-assoc{display:flex;gap:12px;flex-wrap:wrap;margin-top:20px}.profile-assoc span{font-size:12px;font-weight:700;letter-spacing:.08em;text-transform:uppercase}@media(max-width:700px){.profile-team{grid-template-columns:1fr}.profile-hero,.profile-block,.profile-number{padding-left:20px;padding-right:20px}}
...
function manifestoView(data){const r=(data.records||[])[0]||{},a=r.brand_assets||{},st=r.statements||[];const lead=st[1]||st[0]||"";const rest=st.slice(2).join(" ");return '<section class="manifesto"><div><div class="manifesto-top">'+(a.logo_url?'<img class="manifesto-logo" src="'+esc(a.logo_url)+'" alt="Simple">':'<div class="manifesto-kicker">Simple</div>')+'<div class="manifesto-kicker">Manifiesto</div></div><div class="manifesto-line">'+esc(r.tagline||"Ideas primero")+'</div><div class="manifesto-copy"><strong>'+esc(lead)+'</strong>'+(rest?'<br><br>'+esc(rest):'')+'</div></div>'+(a.manifesto_image_url?'<img class="manifesto-sign" src="'+esc(a.manifesto_image_url)+'" alt="">':'')+'</section>'}
function profileView(data){const sections={};for(const s of (data.records||[]))sections[s.section]=s.records||[];const identity=(sections.IDENTITY||[])[0]||{},team=sections.TEAM||[],caps=((sections.CAPABILITIES||[])[0]||{}).areas||[],position=((sections.POSITIONING||[])[0]||{}).statement||"",assoc=sections.ASSOCIATIONS||[];return '<section class="profile-experience"><div class="profile-hero"><div class="profile-kicker">Simple / Chile</div><div><div class="profile-headline">Ideas primero.</div><div class="profile-definition">'+esc(identity.definition||"Agencia creativa independiente")+'</div></div></div><div class="profile-numbers"><div class="profile-number"><div class="profile-big">'+esc(identity.founded||"—")+'</div><div class="profile-label">Desde</div></div><div class="profile-number"><div class="profile-big">'+esc(identity.team_size_declared||"—")+'</div><div class="profile-label">Personas</div></div></div><div class="profile-block"><div class="profile-kicker">Qué hacemos</div><h2>Full service.<br>Sin sonar a full service.</h2><div class="profile-capabilities">'+caps.map(x=>'<span class="profile-pill">'+esc(x)+'</span>').join("")+'</div></div>'+(position?'<div class="profile-block"><div class="profile-kicker">Cómo pensamos</div><div class="profile-position">'+esc(position)+'</div></div>':'')+(team.length?'<div class="profile-block"><div class="profile-kicker">Dirección</div><h2>Las personas<br>detrás de Simple.</h2><div class="profile-team">'+team.map(x=>'<div class="profile-person"><strong>'+esc(x.name)+'</strong><span>'+esc(x.role)+'</span></div>').join("")+'</div></div>':'')+(assoc.length?'<div class="profile-block"><div class="profile-kicker">Somos parte de</div><div class="profile-assoc">'+assoc.map(x=>'<span>'+esc(x.name)+'</span>').join("")+'</div></div>':'')+'</section>'}
...
function render(payload){if(!payload)return;const p=payload.presentation||"GENERIC_LIST",data=payload.data||{};app.innerHTML=p==="WORK_GALLERY"?workGallery(data):p==="CLIENT_GRID"?clientGrid(data):p==="CREDENTIAL_LIST"?credentialList(data):p==="MANIFESTO"?manifestoView(data):p==="PROFILE"||p==="BRAND_IMMERSION"?profileView(data):rowsView(data)}
